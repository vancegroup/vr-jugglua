...
namespace vrjLua {
	...
	class RunLoopManager : public StartingInterface, public LoopInterface, public ShutdownInterface {
		public:
			RunLoopManager() : currentState_(STATE_STOPPED), shouldStop_(false) {}
	...
	inline LoopGuard::LoopGuard(RunLoopManager & mgr, LoopGuard::StartTime t) : mgr_(mgr) {
	...
	inline void RunLoopManager::reportStateChange_(RunLoopManager::RunningState s) {
