...
namespace vrjLua {
    ...
    class OsgAppProxy : public OsgApp {
      public:
        ...
        */
        ...
        /** Interval between the most recent (current) preFrame and the
           previous.

                This is an accessor whose data member is updated in preFrame
           before
        ...
        */
        ...
        /** Called after getting input data but before syncing shared data.
                ...
                @warning Any operation placed here increases total input
           latency!
        */
        ...
        */
        ...
        /** Called once drawing has concluded, before getting the next inputs.
                ...
                (All FrameStateMachines will also trigger their go() method
           here,
    ...
    inline OsgAppProxy *OsgAppProxy::getApp() { return _pApp; }
