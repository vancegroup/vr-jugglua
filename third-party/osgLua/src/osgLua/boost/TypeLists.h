...
namespace osgTraits {
	...
	struct matrix_types : boost::mpl::set< ::osg::Matrixd, ::osg::Matrixf > {};
	struct vector_types : boost::mpl::set< ::osg::Vec2b, ::osg::Vec2d, ::osg::Vec2f, ::osg::Vec2s, ::osg::Vec3b, ::osg::Vec3d, ::osg::Vec3f, ::osg::Vec3s, ::osg::Vec4b, ::osg::Vec4d, ::osg::Vec4f, ::osg::Vec4s, ::osg::Vec4ub > {};
	struct quat_types : boost::mpl::set< ::osg::Quat > {};
